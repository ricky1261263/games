...
function typeIn()
{
    ...
    else if(text == "AES")
    {
        ...
        aesEncryptedMess.innerHTML = "";
    }
    else
    {
        //var a = document.getElementsByClassName('a');
        var quest = document.getElementById("quest");
        var ans = "have you t[r][i]ed all the symbols? IT'S STILL NOT ENOU[G][H] YE[T].";
